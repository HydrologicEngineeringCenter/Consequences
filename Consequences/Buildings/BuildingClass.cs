...
public class BuildingClass : IConsequenceReceptor<DepthHazard, DamageResult>
{
    ...
    public static DamageResult Compute(float depth, BuildingClass building)
    {
    ...
    public static DamageResult Compute(float depth, float velocity, BuildingClass building)
    {
        var occ = building.OccupancyType;
        float effectiveDepth = depth - building.FoundationHeight - building.OccupancyType.FoundationHeightOffset;
        if (effectiveDepth <= 0)
    ...
    public static float ComputeMetal(float depth, BuildingClass building)
    {
        var occ = building.OccupancyType;
        float effectiveDepth = depth - building.FoundationHeight - building.OccupancyType.FoundationHeightOffset;
